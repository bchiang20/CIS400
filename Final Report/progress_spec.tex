...
This section looks at research conducted on sepsis protocols, as well as in clinical decision support systems and the application and implementation of smart alarms in modern hospitals.
...
The user profile page contains basic information about the patient, such as their age and time admitted.  The page also provides a more detailed view of each of the vital signs so that a nurse or physician get get a better snapshot of that patient's history.  While the main page notifies which thresholds were triggered, the patient profile shows how that vital sign has been trending. A consolidated graph as displayed on the profile with each vital sign is shown in Figure~\ref{fig:patient_graph}.
